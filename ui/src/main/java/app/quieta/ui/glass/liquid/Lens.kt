package app.quieta.ui.glass.liquid

// Adapted from Kyant0/AndroidLiquidGlass (Apache-2.0) via InstallerX / compose-miuix-ui.
...
fun BackdropEffectScope.lens(
    ...
    val key = if (dispersionEnabled) "QuietaLensDispersion" else "QuietaLens"
